...
function latex2html($line) {
  ...
  $line = str_replace('\\AA','&Aring;', $line);
   ...
   $line = str_replace('\\v{C}', '&#268;', $line);  
   $line = str_replace('\\v{e}', '&#277;', $line);  
   $line = str_replace('\\v{E}', '&#276;', $line);  
   $line = str_replace('\\v{s}', '&#353;', $line);  
   $line = str_replace('\\v{S}', '&#352;', $line);  
...
class BibEntryDisplay {
  ...
  function setEntries(&$entries) {
    $this->bib = $entries[0];
    //$this->title = $this->bib->getTitle().$this->bib->getUrlLink();
  }
